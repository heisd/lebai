...
bool lebai_interfaces__msg__device_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lebai_interfaces.msg._device_info.DeviceInfo", full_classname_dest, 44) == 0);
  }
  lebai_interfaces__msg__DeviceInfo * ros_message = _ros_message;
  {  // model
...
PyObject * lebai_interfaces__msg__device_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lebai_interfaces.msg._device_info");
