...
class Metaclass_MoveLine(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lebai_interfaces.srv import _move_line
...
class MoveLine(metaclass=Metaclass_MoveLine):
    from lebai_interfaces.srv._move_line import MoveLine_Request as Request
    from lebai_interfaces.srv._move_line import MoveLine_Response as Response
