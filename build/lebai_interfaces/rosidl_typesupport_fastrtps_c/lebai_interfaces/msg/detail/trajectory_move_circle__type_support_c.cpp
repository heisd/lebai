...
#include "lebai_interfaces/msg/detail/trajectory_move_circle__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryMoveCircle__ros_msg_type = lebai_interfaces__msg__TrajectoryMoveCircle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrajectoryMoveCircle__ros_msg_type * ros_message = static_cast<const _TrajectoryMoveCircle__ros_msg_type *>(untyped_ros_message);
  // Field name: common
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrajectoryMoveCircle__ros_msg_type * ros_message = static_cast<_TrajectoryMoveCircle__ros_msg_type *>(untyped_ros_message);
  // Field name: common
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_lebai_interfaces__msg__TrajectoryMoveCircle(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrajectoryMoveCircle__ros_msg_type * ros_message = static_cast<const _TrajectoryMoveCircle__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrajectoryMoveCircle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lebai_interfaces__msg__TrajectoryMoveCircle(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lebai_interfaces
size_t max_serialized_size_lebai_interfaces__msg__TrajectoryMoveCircle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces__msg__TrajectoryMoveCircle;
    is_plain =
      (
...
static size_t _TrajectoryMoveCircle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lebai_interfaces__msg__TrajectoryMoveCircle(
...
static message_type_support_callbacks_t __callbacks_TrajectoryMoveCircle = {
...
static rosidl_message_type_support_t _TrajectoryMoveCircle__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrajectoryMoveCircle,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lebai_interfaces, msg, TrajectoryMoveCircle)() {
  return &_TrajectoryMoveCircle__type_support;
}
