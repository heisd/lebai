...
#include "lebai_interfaces/msg/detail/gripper_status__rosidl_typesupport_fastrtps_c.h"
...
using _GripperStatus__ros_msg_type = lebai_interfaces__msg__GripperStatus;
...
size_t get_serialized_size_lebai_interfaces__msg__GripperStatus(
  const void * untyped_ros_message,
...
static uint32_t _GripperStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lebai_interfaces__msg__GripperStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lebai_interfaces
size_t max_serialized_size_lebai_interfaces__msg__GripperStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces__msg__GripperStatus;
    is_plain =
      (
...
static size_t _GripperStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lebai_interfaces__msg__GripperStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lebai_interfaces, msg, GripperStatus)() {
