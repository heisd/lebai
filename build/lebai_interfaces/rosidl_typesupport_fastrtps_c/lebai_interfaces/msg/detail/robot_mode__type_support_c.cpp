...
#include "lebai_interfaces/msg/detail/robot_mode__rosidl_typesupport_fastrtps_c.h"
...
using _RobotMode__ros_msg_type = lebai_interfaces__msg__RobotMode;
...
static uint32_t _RobotMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_lebai_interfaces__msg__RobotMode(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces__msg__RobotMode;
    is_plain =
      (
...
static size_t _RobotMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_lebai_interfaces__msg__RobotMode(
