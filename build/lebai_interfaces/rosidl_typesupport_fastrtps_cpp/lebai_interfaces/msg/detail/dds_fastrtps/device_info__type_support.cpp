...
#include "lebai_interfaces/msg/detail/device_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lebai_interfaces::msg::DeviceInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lebai_interfaces::msg::DeviceInfo & ros_message)
{
  // Member: model
  cdr >> ros_message.model;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces::msg::DeviceInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lebai_interfaces::msg::DeviceInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lebai_interfaces::msg::DeviceInfo *>(
    untyped_ros_message);
...
{
  return &lebai_interfaces::msg::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lebai_interfaces, msg, DeviceInfo)() {
  return &lebai_interfaces::msg::typesupport_fastrtps_cpp::_DeviceInfo__handle;
}
