...
#include "lebai_interfaces/msg/detail/robot_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lebai_interfaces::msg::RobotMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lebai_interfaces::msg::RobotMode & ros_message)
{
  // Member: val
  cdr >> ros_message.val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces::msg::RobotMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lebai_interfaces::msg::RobotMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lebai_interfaces::msg::RobotMode *>(
    untyped_ros_message);
...
{
  return &lebai_interfaces::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lebai_interfaces, msg, RobotMode)() {
  return &lebai_interfaces::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
