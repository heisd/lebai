...
#include "lebai_interfaces/msg/detail/tri_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces::msg::TriState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lebai_interfaces::msg::TriState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lebai_interfaces::msg::TriState *>(
    untyped_ros_message);
...
{
  return &lebai_interfaces::msg::typesupport_fastrtps_cpp::_TriState__handle;
}
