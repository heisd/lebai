...
#include "lebai_interfaces/srv/detail/move_circle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const lebai_interfaces::srv::MoveCircle_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lebai_interfaces::srv::MoveCircle_Request & ros_message)
{
  // Member: way_point_is_joint_pose
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = lebai_interfaces::srv::MoveCircle_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lebai_interfaces::srv::MoveCircle_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<lebai_interfaces::srv::MoveCircle_Request *>(
    untyped_ros_message);
...
{
  return &lebai_interfaces::srv::typesupport_fastrtps_cpp::_MoveCircle_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lebai_interfaces, srv, MoveCircle_Request)() {
  return &lebai_interfaces::srv::typesupport_fastrtps_cpp::_MoveCircle_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_lebai_interfaces
cdr_serialize(
  const lebai_interfaces::srv::MoveCircle_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ret
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  lebai_interfaces::srv::MoveCircle_Response & ros_message)
{
  // Member: ret
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = lebai_interfaces::srv::MoveCircle_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const lebai_interfaces::srv::MoveCircle_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<lebai_interfaces::srv::MoveCircle_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &lebai_interfaces::srv::typesupport_fastrtps_cpp::_MoveCircle_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lebai_interfaces, srv, MoveCircle_Response)() {
  return &lebai_interfaces::srv::typesupport_fastrtps_cpp::_MoveCircle_Response__handle;
}
...
{
  return &lebai_interfaces::srv::typesupport_fastrtps_cpp::_MoveCircle__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lebai_interfaces, srv, MoveCircle)() {
  return &lebai_interfaces::srv::typesupport_fastrtps_cpp::_MoveCircle__handle;
}
