...
#ifndef LEBAI_INTERFACES__SRV__DETAIL__MOVE_CIRCLE__FUNCTIONS_H_
#define LEBAI_INTERFACES__SRV__DETAIL__MOVE_CIRCLE__FUNCTIONS_H_
 ...
 * calls
 * lebai_interfaces__srv__MoveCircle_Request__init().
...
/**
 * It calls
 * lebai_interfaces__srv__MoveCircle_Request__fini()
 ...
 * lebai_interfaces__srv__MoveCircle_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * lebai_interfaces__srv__MoveCircle_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * lebai_interfaces__srv__MoveCircle_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lebai_interfaces
...
/**
 * It calls
 * lebai_interfaces__srv__MoveCircle_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_lebai_interfaces
...
/**
 * It allocates the memory for the array and calls
 * lebai_interfaces__srv__MoveCircle_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_lebai_interfaces
...
/**
 * It calls
 * lebai_interfaces__srv__MoveCircle_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LEBAI_INTERFACES__SRV__DETAIL__MOVE_CIRCLE__FUNCTIONS_H_
