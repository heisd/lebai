...
{
  new (message_memory) lebai_interfaces::msg::RobotMode(_init);
}

void RobotMode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<lebai_interfaces::msg::RobotMode *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotMode_message_member_array[1] = {
  {
    ...
    offsetof(lebai_interfaces::msg::RobotMode, val),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotMode_message_members = {
  ...
  1,  // number of fields
  sizeof(lebai_interfaces::msg::RobotMode),
...
{
  return &::lebai_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lebai_interfaces, msg, RobotMode)() {
  return &::lebai_interfaces::msg::rosidl_typesupport_introspection_cpp::RobotMode_message_type_support_handle;
}
