...
#ifndef LEBAI_INTERFACES__MSG__DETAIL__DEVICE_INFO__TRAITS_HPP_
#define LEBAI_INTERFACES__MSG__DETAIL__DEVICE_INFO__TRAITS_HPP_
...
inline void to_yaml(
  const lebai_interfaces::msg::DeviceInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lebai_interfaces::msg::DeviceInfo & msg)
{
  return lebai_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<lebai_interfaces::msg::DeviceInfo>()
{
  return "lebai_interfaces::msg::DeviceInfo";
}

template<>
inline const char * name<lebai_interfaces::msg::DeviceInfo>()
{
  return "lebai_interfaces/msg/DeviceInfo";
}

template<>
struct has_fixed_size<lebai_interfaces::msg::DeviceInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<lebai_interfaces::msg::DeviceInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<lebai_interfaces::msg::DeviceInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // LEBAI_INTERFACES__MSG__DETAIL__DEVICE_INFO__TRAITS_HPP_
