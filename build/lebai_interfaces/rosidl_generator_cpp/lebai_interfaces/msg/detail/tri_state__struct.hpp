...
#ifndef LEBAI_INTERFACES__MSG__DETAIL__TRI_STATE__STRUCT_HPP_
#define LEBAI_INTERFACES__MSG__DETAIL__TRI_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lebai_interfaces__msg__TriState __attribute__((deprecated))
#else
# define DEPRECATED__lebai_interfaces__msg__TriState __declspec(deprecated)
#endif
...
struct TriState_
{
  ...
  using ConstRawPtr =
    const lebai_interfaces::msg::TriState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lebai_interfaces::msg::TriState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lebai_interfaces__msg__TriState
    std::shared_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lebai_interfaces__msg__TriState
    std::shared_ptr<lebai_interfaces::msg::TriState_<ContainerAllocator> const>
...
using TriState =
  lebai_interfaces::msg::TriState_<std::allocator<void>>;
...
#endif  // LEBAI_INTERFACES__MSG__DETAIL__TRI_STATE__STRUCT_HPP_
