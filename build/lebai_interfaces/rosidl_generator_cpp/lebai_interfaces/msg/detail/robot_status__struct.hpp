...
#ifndef LEBAI_INTERFACES__MSG__DETAIL__ROBOT_STATUS__STRUCT_HPP_
#define LEBAI_INTERFACES__MSG__DETAIL__ROBOT_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__lebai_interfaces__msg__RobotStatus __attribute__((deprecated))
#else
# define DEPRECATED__lebai_interfaces__msg__RobotStatus __declspec(deprecated)
#endif
...
struct RobotStatus_
{
  ...
  using _e_stopped_type =
    lebai_interfaces::msg::TriState_<ContainerAllocator>;
  ...
  Type & set__mode(
    const lebai_interfaces::msg::RobotMode_<ContainerAllocator> & _arg)
  {
    this->mode = _arg;
    return *this;
  }
  Type & set__e_stopped(
    const lebai_interfaces::msg::TriState_<ContainerAllocator> & _arg)
  {
    this->e_stopped = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    lebai_interfaces::msg::RobotStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const lebai_interfaces::msg::RobotStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      lebai_interfaces::msg::RobotStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__lebai_interfaces__msg__RobotStatus
    std::shared_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__lebai_interfaces__msg__RobotStatus
    std::shared_ptr<lebai_interfaces::msg::RobotStatus_<ContainerAllocator> const>
...
using RobotStatus =
  lebai_interfaces::msg::RobotStatus_<std::allocator<void>>;
...
#endif  // LEBAI_INTERFACES__MSG__DETAIL__ROBOT_STATUS__STRUCT_HPP_
