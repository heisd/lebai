...
class Metaclass_TrajectoryMoveCircle(type):
    """Metaclass of message 'TrajectoryMoveCircle'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'lebai_interfaces.msg.TrajectoryMoveCircle')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__trajectory_move_circle
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__trajectory_move_circle
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__trajectory_move_circle
            cls._TYPE_SUPPORT = module.type_support_msg__msg__trajectory_move_circle
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__trajectory_move_circle
...
class TrajectoryMoveCircle(metaclass=Metaclass_TrajectoryMoveCircle):
    """Message class 'TrajectoryMoveCircle'."""
