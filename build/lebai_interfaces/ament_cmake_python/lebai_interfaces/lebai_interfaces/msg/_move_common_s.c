...
bool lebai_interfaces__msg__move_common__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lebai_interfaces.msg._move_common.MoveCommon", full_classname_dest, 44) == 0);
  }
  lebai_interfaces__msg__MoveCommon * ros_message = _ros_message;
  {  // vel
...
{
  /* NOTE(esteve): Call constructor of MoveCommon */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lebai_interfaces.msg._move_common");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MoveCommon");
