...
def generate_launch_description():
    ...
    # 修改这个数值 @li
    #  "trajectory_execution.allowed_execution_duration_scaling": 1.2, ->3.0
    #  "trajectory_execution.allowed_goal_duration_margin": 0.5, ->2.0
    ...
    static_tf_hand_eye = Node(
        package="tf2_ros",
        executable="static_transform_publisher",
        name="hand_eye",
        output="log",
        #"0.129980", "0.013859", "-0.013196" ,"-0.026010" ,"0.727027" ,"-0.012207" ,"0.686008"
        
        arguments=["0.110232", "0.007597", "0.011786" ,"-0.025476" ,"0.725284" ,"-0.004022" ,"0.687967","lebai_tool0", "camera_link"],
    )              
