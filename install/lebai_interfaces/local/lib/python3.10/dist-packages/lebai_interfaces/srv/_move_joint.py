...
class Metaclass_MoveJoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lebai_interfaces.srv import _move_joint
...
class MoveJoint(metaclass=Metaclass_MoveJoint):
    from lebai_interfaces.srv._move_joint import MoveJoint_Request as Request
    from lebai_interfaces.srv._move_joint import MoveJoint_Response as Response
