...
class Metaclass_TrajectoryMoveLine(type):
    """Metaclass of message 'TrajectoryMoveLine'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'lebai_interfaces.msg.TrajectoryMoveLine')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__trajectory_move_line
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__trajectory_move_line
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__trajectory_move_line
            cls._TYPE_SUPPORT = module.type_support_msg__msg__trajectory_move_line
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__trajectory_move_line
...
class TrajectoryMoveLine(metaclass=Metaclass_TrajectoryMoveLine):
    """Message class 'TrajectoryMoveLine'."""
